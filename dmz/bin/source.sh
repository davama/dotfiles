...
testing4=$(grep rundeck-lab /etc/hosts | grep "10\." | awk '{print $1}')
testing5=$(grep netbox-lab /etc/hosts | grep "10\." | awk '{print $1}')
...
#windowsbox=$(grep usrdcb014 /etc/hosts | grep "10\." | awk '{print $1}')
windowsbox=$(grep usrds114 /etc/hosts | grep "10\." | awk '{print $1}')
windowsbox=$(grep usrds115 /etc/hosts | grep "10\." | awk '{print $1}')
